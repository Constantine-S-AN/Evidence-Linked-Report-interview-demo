  ...
  const prompt = JSON.stringify(
    {
      ...
      instructions: [
        ...
        "Treat this as interviewer loop notes, not generic feedback.",
        ...
        "Each observation should be supported by cited segmentId evidence unless notObserved=true.",
        "Provide anchorAlignment fields with chosenLevel, whyMeets, and whyNotHigher.",
        "Provide 2-4 concise observations and 2-3 probes per dimension.",
        ...
        "Include top-level decisionRationale, keyStrengths, keyRisks, and mustFixToHire.",
      ],
    },
    null,
    2,
